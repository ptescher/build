...
function post_family_config__orangepicm4_use_mainline_uboot() {
	display_alert "$BOARD" "mainline u-boot overrides" "info"

	BOOTSOURCE="https://github.com/Kwiboo/u-boot-rockchip.git"
	BOOTBRANCH="commit:0bc339ffa6f804d51c5c5292d8ff69c4d79614d3" # specific commit, from "branch:rk3568-2023.10"
...
function add_host_dependencies__new_uboot_wants_python3_orangepicm4() {
	declare -g EXTRA_BUILD_DEPS="${EXTRA_BUILD_DEPS} python3-pyelftools" # @TODO: convert to array later
}

function post_family_tweaks_bsp__orangepicm4() {
	display_alert "$BOARD" "Installing sprd-bluetooth.service" "info"

	# Bluetooth on orangepicm4 board is handled by a Spreadtrum (sprd) chip and requires
...
function post_family_tweaks__orangepicm4_enable_services() {
